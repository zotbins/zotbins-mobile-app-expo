...
const minDiversionValue = CalculateDiversionRate(
  minRecyclableValue,
  minCompostValue,
  minWasteValue
);
...
const maxDiversionValue = CalculateDiversionRate(
  maxRecyclableValue,
  maxCompostValue,
  maxWasteValue
);
      ...
      <View>
        ...
        >
          ...
          <View style={{ flex: 10, marginTop: 5 }}>
            <View style={{ alignItems: "center" }}>
              <Text style={{ justifyContent: "center", fontSize: 30 }}>
                {"1Y Data Trends"}
              </Text>
            </View>
            <View style={{ flex: 10, flexDirection: "row" }}>
              ...
              >
                <Text style={{ fontSize: 22, color: ZotBinColors.wasteColor }}>
                  Waste
                </Text>
                <Text style={{ fontSize: 22 }}>{averageWasteValue}%</Text>
                <Text
                  style={{ fontSize: 16, color: ZotBinColors.inactiveColor }}
                >
                  Avg.
                </Text>
              ...
              >
                <Text
                  style={{ fontSize: 22, color: ZotBinColors.recyclableColor }}
                >
                  Recycle
                </Text>
              ...
              >
                <Text
                  style={{ fontSize: 22, color: ZotBinColors.compostColor }}
                >
                  Compost
                </Text>
              ...
              <View
                style={{
                  ...
                  marginTop: 30,
                  alignItems: "center",
                  borderColor: ZotBinColors.blackColor,
                  borderBottomWidth: 5,
                }}
              >
                <Text style={{ fontSize: 22, color: ZotBinColors.blackColor }}>
                  {"D. R."}
                </Text>
