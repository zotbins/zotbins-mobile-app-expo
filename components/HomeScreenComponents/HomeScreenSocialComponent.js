    ...
    <View style={{flex: 2}}>
        ...
        <View style={{flex: 5, backgroundColor: "white", justifyContent: "center"}}>
            <StackedBarChart
                ...
                barColors: [ZotBinColors.wasteColor, ZotBinColors.recyclableColor, ZotBinColors.compostColor],
                }}
                ...
                <View style={{flex: 2, justifyContent: "center", backgroundColor: "white"}}>
                    ...
                    <View style={{flex: 1, flexDirection: "row", marginTop: 25}}>
                        <View style={{flex: 1, alignItems: "center"}}>
                            ...
                            <Text style={{fontSize: 16, color: ZotBinColors.inactiveColor}}>Avg. Diversion Rate</Text>
                        </View>
                        <View style={{flex: 1, alignItems: "center"}}>
                            <Text style={{fontSize: 22}}>{myDiversionValue}%</Text>
                            <Text style={{fontSize: 16, color: ZotBinColors.inactiveColor}}>Your Diversion Rate</Text>
                        </View>
                    </View>
                    <View style={{flex: 1, flexDirection: "row"}}>
                        <View style={{flex: 1, alignItems: "center"}}>
                            <Text style={{fontSize: 30}}>{myDiversionPercentile}th</Text>
                            <Text style={{fontSize: 24, color: ZotBinColors.inactiveColor}}>Zero-Waste Percentile</Text>
                        </View>
                    </View>
                </View>
            </View>
